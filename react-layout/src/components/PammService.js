...
function PammService() {
    ...
    <div className="pamm-container">
        ...
        <Text title='SOFT-FX PAMM Service' subtitle='The Soft-FX PAMM Service is a software 
                solution that makes possible to copy trade operations from Master account to 
                one or more Slaves accounts and it helps to automatize profit/loss distribution. 
                Master operates his/her personal capital through a given PAMM Account, and his/her 
                trading strategy is replicated on the Slaves own capital. PAMM Account performance 
                can be viewed and analyzed with the help of advanced analytics that provides information 
                in digital and graphic ways.' />
